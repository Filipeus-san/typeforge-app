...
function handleCategoryCreate(request: Request, response: Response): Response {
    ...
    try {
        ...
        insertCategory(data.name, slug, data.description, data.icon, data.status, sortOrder);
...
function handleCategoryEdit(request: Request, response: Response, category: DbCategory): Response {
    ...
    try {
        ...
        updateCategory(category.id, data.name, slug, data.description, data.icon, data.status, sortOrder);
